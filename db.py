...
class User(db.Model):
    ...
    def __init__(self, **kwargs):
        ...
        self.public_email = kwargs.get("email", "")
...
class Organization(db.Model):
    ...
    def __init__(self, **kwargs):
        ...
        self.name = kwargs.get("name", "")
        self.org_pfp = kwargs.get("org_pfp", "")
        self.org_bio = kwargs.get("org_bio", "")
        self.org_banner = kwargs.get("org_banner", "")
...
class Position(db.Model):
    ...
    user_organizations = db.relationship("User_Org", back_populates="position")
...
class User_Org(db.Model):
    ...
    position = db.relationship("Position", back_populates="user_organizations")
